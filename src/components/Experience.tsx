...
const Experience: React.FC = () => {
  ...
  return (
    <section id="experience" className="py-16 md:py-20 bg-gradient-to-br from-slate-50 to-blue-50">
              ...
              >
                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 hover:shadow-xl transition-shadow duration-300">
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4 md:mb-6">
                    ...
                    <div>
                      <span className="px-3 md:px-4 py-1 md:py-2 bg-blue-100 text-blue-700 rounded-full text-xs md:text-sm font-medium">
                        {exp.period}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="mb-4 md:mb-6">
                    <h4 className="font-semibold text-gray-800 mb-2 md:mb-3 text-sm md:text-base">Key Achievements:</h4>
